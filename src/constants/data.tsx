...
export const tabs: { name: Category; icon: React.ReactNode }[] = [
  { name: "Home", icon: <Compass size={17} strokeWidth={1.75} /> },
  { name: "Links", icon: <LinkIcon size={17} strokeWidth={1.75} /> },
  { name: "Store", icon: <ShoppingBag size={17} strokeWidth={1.75} /> },
  { name: "Apps", icon: <LayoutGrid size={17} strokeWidth={1.75} /> },
  { name: "Flagships", icon: <Sparkles size={17} strokeWidth={1.75} /> },
  { name: "Journal", icon: <BookOpen size={17} strokeWidth={1.75} /> },
  { name: "Projects", icon: <FolderGit2 size={17} strokeWidth={1.75} /> },
  { name: "Ebooks", icon: <Book size={17} strokeWidth={1.75} /> },
  { name: "Automation", icon: <Cpu size={17} strokeWidth={1.75} /> },
  { name: "About", icon: <User size={17} strokeWidth={1.75} /> },
  { name: "Reviews", icon: <Star size={17} strokeWidth={1.75} /> },
  { name: "Connect", icon: <Send size={17} strokeWidth={1.75} /> },
  { name: "Vortex", icon: <Wand2 size={17} strokeWidth={1.75} /> },
  { name: "Services", icon: <SlidersHorizontal size={17} strokeWidth={1.75} /> },
  { name: "Prompts", icon: <Command size={17} strokeWidth={1.75} /> },
  { name: "Community", icon: <Users size={17} strokeWidth={1.75} /> },
  { name: "Academy", icon: <GraduationCap size={17} strokeWidth={1.75} /> },
  { name: "Music", icon: <Headphones size={17} strokeWidth={1.75} /> },
  { name: "Blog", icon: <FileText size={17} strokeWidth={1.75} /> },
  { name: "Feed", icon: <Rss size={17} strokeWidth={1.75} /> },
  { name: "Toolspedia", icon: <Wrench size={17} strokeWidth={1.75} /> },
];
...
export const projects: ProjectType[] = [
  {
    ...
    tags: ["Web Design", "Enterprise", "React", "Design System"],
    pricing: "Free",
    desc: "A flagship enterprise digital portal and high-performance web platform built with custom architectural layouts, fluid transitions, and responsive micro-interactions.",
  ...
  {
    name: "Solution Lab — Digital Innovations Portal",
    mainCategory: "Web Development Projects",
    categories: ["Web Development Projects", "Pro Business Suite"],
    tags: ["Web Design", "Digital Lab", "Interactive", "Architecture"],
    pricing: "Free",
    desc: "An innovative digital solutions lab and modern creative engineering portal showcasing next-generation web architectures and interactive web layouts.",
