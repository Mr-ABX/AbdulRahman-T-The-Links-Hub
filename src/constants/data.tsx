...
export const projects: ProjectType[] = [
  {
    ...
    url: "https://infni-t.com",
    previewUrl: "https://infni-t.com",
  ...
  {
    name: "VibeFlex — Motion Ad & Commercial Reel 01",
    mainCategory: "Video & Motion Graphics",
    categories: ["Video & Motion Graphics", "Graphics & Marketing"],
    tags: ["VibeFlex", "Motion Graphics", "Commercial Ads", "3D VFX"],
    pricing: "Free",
    desc: "High-impact commercial video ad and kinetic motion reel produced under the VibeFlex brand suite with 3D CGI transitions and brand typography.",
    url: "https://www.youtube.com/watch?v=sU9o-gyVQ8U",
    youtubeId: "sU9o-gyVQ8U",
    previewUrl: "https://www.youtube.com/embed/sU9o-gyVQ8U?enablejsapi=1&autoplay=1&mute=1&loop=1&playlist=sU9o-gyVQ8U&controls=1&modestbranding=1&rel=0&playsinline=1",
    color: "text-pink-400",
    bg: "bg-pink-500/10",
    icon: <Video size={20} />,
    status: "Production",
  ...
  {
    name: "VibeFlex — Creative Studio Campaign Reel 02",
    mainCategory: "Video & Motion Graphics",
    categories: ["Video & Motion Graphics", "Graphics & Marketing"],
    tags: ["VibeFlex", "Video Production", "Brand Ads", "3D Motion"],
    pricing: "Free",
    desc: "Creative brand commercial and motion graphic sequence crafted for maximum audience engagement with synchronized audio and high-framerate rendering.",
    url: "https://www.youtube.com/watch?v=VULB6DCUniI",
    youtubeId: "VULB6DCUniI",
    previewUrl: "https://www.youtube.com/embed/VULB6DCUniI?enablejsapi=1&autoplay=1&mute=1&loop=1&playlist=VULB6DCUniI&controls=1&modestbranding=1&rel=0&playsinline=1",
